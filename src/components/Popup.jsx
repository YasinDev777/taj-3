  ...
  return (
    <div className="popav" style={isAlert === true || isVideo === true ? { display: 'flex' } : { display: 'none' }} onClick={handleNone}>
      ...
      <div className="video-alert" style={isVideo === true ? { display: 'flex' } : { display: 'none' }}>
        ...
        <iframe width="100%" height="100%" src={isVideo === true ? `https://www.youtube.com/embed/Hd8IWQ8M1NY` : ''} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>
    </div>
  );
};
